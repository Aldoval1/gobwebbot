...
GOBIERNO_GUILD_ID = int(os.getenv("GOBIERNO_GUILD_ID") or 1407095652718215480)
JUDICIAL_GUILD_ID = int(os.getenv("JUDICIAL_GUILD_ID") or 1451589869397737625)
CONGRESO_GUILD_ID = int(os.getenv("CONGRESO_GUILD_ID") or 1461529761783353347)
